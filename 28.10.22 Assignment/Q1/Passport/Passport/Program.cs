...
namespace Assign_28_Oct_Q1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            try
            {
                string connection = "Data Source=INLPF37B1HY\\MSSQLSERVER1;Initial Catalog=PassPort;trusted_connection=true";
                ...
                Console.WriteLine("5. Enter applied through channel");
                string applied = Console.ReadLine();
                SqlCommand cmd = new SqlCommand("Pass_Port", sqlcon);
